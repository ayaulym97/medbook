...
export default class doctorProfile extends React.Component{
    ...
    doctorProfile(){
        ...
        //console.log(this.state.doctorCard.service,"Service");
        DoctorService.getDoctorProfile(this.state.doctorId).then((response) => {
            ...
            // console.log(this.state.doctorCard,"RESPONSE");
            this.state.doctorCard.map((service)=>{
    ...
    request(){
        ...
        DoctorService.doctorRequest(data).then((response)=>{
